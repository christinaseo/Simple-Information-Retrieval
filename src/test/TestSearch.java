...
public class TestSearch {
	...
	public static void main(String[] args) {
		...
		TestIndex(new index.InvertedIndex(new soln.io.FileDocSource("Extracted NSF/Part1/awards_1990"), 
		...
		TestIndex(new index.InvertedIndex(new io.FileDocSource("Extracted NSF/Part1/awards_1990"), 
